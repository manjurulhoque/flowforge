...
export function TopToolbar() {
	...
	return (
		<header className="relative z-30 flex h-14 shrink-0 items-center gap-2 border-b border-zinc-200 bg-white/90 px-3 backdrop-blur-md">
			<button
				onClick={() => router.push("/")}
				className="flex items-center gap-2 rounded-lg px-1.5 py-1 transition-colors hover:bg-zinc-100"
			>
				<div className="flex h-7 w-7 items-center justify-center rounded-lg bg-zinc-900 text-[13px] font-bold text-white">
					F
				</div>
