		...
		<div className="min-h-screen bg-zinc-50">
			<header className="sticky top-0 z-20 border-b border-zinc-200 bg-white/90 backdrop-blur-md">
				<div className="mx-auto flex h-16 max-w-6xl items-center gap-3 px-6">
					<div className="flex h-8 w-8 items-center justify-center rounded-lg bg-zinc-900 text-[15px] font-bold text-white">
						F
					</div>
					...
					<div className="ml-auto flex items-center gap-2">
						<div className="flex h-8 w-8 items-center justify-center rounded-full bg-zinc-200 text-[11px] font-medium text-zinc-600">
							AK
						</div>
					</div>
				</div>
...
function ProjectCard({
	...
	return (
		<motion.div
			...
			className="group relative cursor-pointer rounded-2xl border border-zinc-200 bg-white p-5 transition-all hover:border-zinc-300 hover:shadow-sm"
		>
				...
				<div className="relative">
					...
					{menu && (
						<div
							...
							className="absolute right-0 top-full z-10 mt-1 w-40 overflow-hidden rounded-lg border border-zinc-200 bg-white p-1 shadow-lg"
						>
							<MenuItem
