...
export function BottomPanel() {
	...
	return (
		<div className="flex shrink-0 flex-col border-t border-zinc-200 bg-zinc-100">
		...
		<div className="space-y-1.5">
			{issues.map((issue) => (
				<button
					...
					className="flex w-full items-start gap-2.5 rounded-lg border border-zinc-200 bg-zinc-100 p-2.5 text-left transition-colors hover:bg-zinc-50"
				>
	...
	return (
		<div className="space-y-2">
			...
			{(data ?? []).map((s) => (
				<div
					key={s.id}
					className="rounded-lg border border-zinc-200 bg-zinc-100 p-2.5"
				>
