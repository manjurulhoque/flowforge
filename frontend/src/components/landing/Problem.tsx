			...
			<div className="mx-auto max-w-5xl">
				<Reveal className="max-w-xl">
					<h2 className="text-2xl sm:text-[2rem] font-semibold text-[var(--text-primary)]">
						Architecture that&rsquo;s reviewable, testable, and
						exportable
					</h2>
					<p className="mt-4 text-[15px] text-[var(--text-secondary)] leading-relaxed">
						Most teams describe their system twice: once in a
						diagramming tool nobody maintains, and once in the code
						that actually ships. FlowForge makes the diagram the
						source of truth &mdash; one that can be validated and
						exported like any other artifact.
					</p>
				</Reveal>
