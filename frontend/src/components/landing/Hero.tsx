...
const badges = ["PostgreSQL", "Redis", "Docker", "Kubernetes", "Terraform", "OpenAI"];
  ...
  return (
    <section className="relative pt-36 pb-20 sm:pt-44 sm:pb-28 px-5 sm:px-8 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          Drag services onto a canvas, connect them the way they actually talk,
          and let the rule engine catch anti-patterns before they ship. Then
          export straight to the artifacts your stack already reads.
        </motion.p>
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
          {badges.map((b) => (
            <span key={b} className="mono text-[12.5px] text-[var(--text-secondary)]">
              {b}
            </span>
          ))}
        </div>
