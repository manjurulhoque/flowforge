...
const quotes = [
	{
		quote: "We caught a shared-database anti-pattern in review that would've taken an incident to surface otherwise. The validation panel paid for the seat in the first week.",
		name: "Priya Nandakumar",
		role: "Platform Engineer",
		company: "Ledgerly",
	},
	{
		quote: "Export to Docker Compose is exactly right — it's the same file our onboarding script already expects, not a new format to reconcile.",
		name: "Tomas Vranić",
		role: "Staff Engineer",
		company: "Northwind Freight",
	},
	{
		quote: "The canvas replaced our draw.io board and the doc that was always a version behind it. Now there's one artifact, and it's checked automatically.",
		name: "Ade Okafor",
